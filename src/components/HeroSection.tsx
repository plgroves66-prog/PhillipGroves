      ...
      <div className="container mx-auto px-6 py-20 relative z-10">
        <div className="max-w-3xl">
          <p className="text-primary font-display font-semibold tracking-widest uppercase text-sm mb-4 animate-fade-in">
            Available for Part-Time Work · Tulsa, OK
          </p>
          ...
          <p className="text-lg md:text-xl text-muted-foreground max-w-xl mb-10 animate-fade-in-up" style={{ animationDelay: "0.15s" }}>
            Reliable, detail-oriented worker with experience in retail, inventory, customer service, and facility upkeep.
            Open to part-time roles in retail, stocking, lobby support, light warehouse, and more.
          </p>
